...
aa.env.setValue("newExpStatus", "About to Expire");				
aa.env.setValue("newAppStatus", "");			
aa.env.setValue("gracePeriodDays", "0");				
aa.env.setValue("setPrefix", "");						
aa.env.setValue("inspSched", "");							
aa.env.setValue("skipAppStatusArray", "");	
aa.env.setValue("emailAddress", "Deanna.Hoops@woolpert.com");					
aa.env.setValue("sendEmailToContactTypes",  "License Holder");
aa.env.setValue("emailTemplate", "LICENSESABOUTTOEXP");					
